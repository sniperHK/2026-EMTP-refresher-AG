...
export const questions: Question[] = [
  ...
  },
  {
    ...
    question: "嚴重創傷休克病人，周邊脈搏摸不到，意識躁動。依 XABCDE 流程，此時最優先的處置目標是？",
    options: [
      "插管 (Intubation) 以確保呼吸道",
      "給予鎮靜劑 (Sedation) 讓病人安靜",
      "文獻回顧顯示需維持 SBP > 140 mmHg",
      "控制大出血並恢復灌流 (X: eXsanguinating hemorrhage control)",
    ],
    answer: "D",
    explanation: "依 XABCDE 流程，X（控制致命性大出血）優先於 A（呼吸道）。此情境病人為出血性休克，需先止血並補液。此時若貿然 RSI 插管，藥物會導致血管擴張，正壓通氣減少回心血流，可能導致病人當場 OHCA。",
  },
  {
    ...
    answer: "B",
    explanation: "EtCO₂ 反映心輸出量 (Cardiac Output)。當循環衰竭，肺部血流減少，無法將 CO₂ 帶到肺泡排出，導致 EtCO₂ 驟降。這是即將或已經 Cardiac Arrest 的重要警訊。關鍵鑑別：若氣管內管滑脫 (Extubation)，EtCO₂ 波形會突然消失（降至 0 或接近 0）且波形不規則或完全消失，而非維持規律波形。本題題幹強調「波形仍規律」，代表管路仍在氣管內，但肺循環血流大幅減少，指向循環衰竭而非管路問題。",
  },
  {
  ...
  },
  {
    ...
    question: "IO (Intraosseous) 建立後，依台北市作業手冊，正確的確認與給藥順序為？",
    options: [
      "直接推藥，不需確認位置",
      "旋轉針頭確認深度 → 直接推藥",
  ...
  },
  {
    ...
    options: [
      "1:1,000 (1mg/1ml) IV push（原液靜脈推注）",
      "1:1,000 (1mg/1ml) IM 肌肉注射",
      "稀釋後 10mcg/mL IV push（Push-dose 濃度）",
      "1:1,000 (1mg/1ml) SC 皮下注射",
    ],
    answer: "B",
    explanation: "過敏性休克首選 IM (大腿外側)，濃度用原液 1:1,000。台灣現場只有 1:1,000 (1mg/1mL) 一種 Epinephrine。A 錯：原液 IV push 1mg 對心臟風險極大。C 錯：Push-dose 濃度用於低血壓升壓，非過敏首選。D 錯：SC 吸收太慢，已非建議途徑。",
  },
  {
  ...
  },
  {
    ...
    question: "內科 OHCA 病人，CPR 過程中 rhythm check 顯示 narrow-complex sinus rhythm（HR 65），頸動脈脈搏摸不到。快速 POCUS 確認心臟有微弱收縮活動。此狀態最可能是？",
    options: [
      "True PEA（心臟已無有效收縮）",
      "ROSC（已恢復自主循環）",
      "PseudoPEA（心臟仍有收縮但心輸出量極低）",
      "Pulseless VT（無脈搏心室頻脈）",
    ],
    answer: "C",
    explanation: "ECG 有 organized rhythm + 無脈搏 + POCUS 確認有心臟收縮 = PseudoPEA。與 True PEA 不同，心臟還在跳但 CO 極低（SBP < 40-50 mmHg），摸不到脈搏。處置是 push-dose epi 10-20 mcg（非 ACLS 全量 1 mg），目標是提升 CO 讓脈搏可觸及。D 選項為 VT 波形（wide-complex），與題幹 narrow-complex sinus 不符。",
  },
  {
